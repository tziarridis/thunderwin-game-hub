...
import { Search, Plus, Edit, Trash, Users, Zap, Gift, BadgeDollarSign, Award, Star, Percent, User } from "lucide-react";
      ...
      <div className="container mx-auto py-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleVipLevelChange('withdrawalLimit', parseInt(e.target.value) || 1000)}
                      className="border-white/10"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      className="h-32 border-white/10"
        ...
        <Dialog open={isBonusDialogOpen} onOpenChange={setIsBonusDialogOpen}>
          <DialogContent className="bg-casino-thunder-dark border-white/10 max-w-3xl">
            <DialogHeader>
              <DialogTitle>
                {editingBonus && bonusTemplates.some(b => b.id === editingBonus.id) ? 'Edit Bonus Template' : 'Add Bonus Template'}
              </DialogTitle>
              <DialogDescription>
                Configure the bonus template details and requirements
              </DialogDescription>
            </DialogHeader>
            ...
            {editingBonus && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label>Wager Multiplier ({editingBonus.wagerMultiplier}x)</Label>
                    <Slider
                      value={[editingBonus.wagerMultiplier]}
                      min={1}
                      max={50}
                      step={1}
                      onValueChange={(values) => handleBonusChange('wagerMultiplier', values[0])}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleBonusChange('duration', parseInt(e.target.value) || 7)}
                      className="border-white/10"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      value={editingBonus.requiredVipLevel.toString()}
        ...
        <Dialog open={isUserVipDialogOpen} onOpenChange={setIsUserVipDialogOpen}>
          <DialogContent className="bg-casino-thunder-dark border-white/10">
            <DialogHeader>
              <DialogTitle>Update VIP Status</DialogTitle>
              <DialogDescription>
                Update VIP level for {editingUserVip?.name || editingUserVip?.username}
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="space-y-4 py-4">
                <div className="flex items-center justify-center mb-2">
                  <div className="h-20 w-20 rounded-full bg-white/10 flex items-center justify-center">
                    {editingUserVip.avatarUrl ? (
                      <img 
                        src={editingUserVip.avatarUrl} 
                        alt={editingUserVip.name || editingUserVip.username} 
                ...
                <div className="text-center mb-6">
                  <h3 className="text-lg font-semibold">
                    {editingUserVip.name || editingUserVip.username}
                  </h3>
                  <p className="text-white/60">{editingUserVip.email}</p>
                </div>
                
                <div className="space-y-4">
                  <Label htmlFor="vipLevel">VIP Level</Label>
                  <Select
                    value={editingUserVip.vipLevel?.toString() || "0"}
                    onValueChange={(value) => {
                      setEditingUserVip({
                        ...editingUserVip,
                ...
                {editingUserVip.vipLevel !== undefined && (
                  <div className="bg-white/5 rounded-lg p-4 mt-4">
                    <h4 className="font-medium mb-2">Selected VIP Level Benefits</h4>
                    <ul className="space-y-1">
