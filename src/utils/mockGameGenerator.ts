 ...
 * @returns Array of mock games
 */
export function generateMockGamesForProvider(providerCode: string, count: number) {
 ...
 */
export function normalizeGames(games: any[], providerConfig: any) {
